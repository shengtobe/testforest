...
export const SafeFileRouter = [
    // ----------------- 規章文件 -----------------
    {
        ...
        component: () => import('@/views/smis/safeFile/Regulations.vue')
    },
    ...
    // ----------------- 安全會議文件 -----------------
    {
        ...
        component: () => import('@/views/smis/safeFile/Meeting.vue')
    },
    ...
    // ----------------- 行車事故事件附件 -----------------
    {
        ...
        component: () => import('@/views/smis/safeFile/DrivingAnnex.vue')
    },
]
