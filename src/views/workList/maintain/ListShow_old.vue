...
export default {
    data: () => ({
        ...
        topItems: {  // 上面的欄位
            ...
            fixUnit: { icon: 'mdi-apps', title: '立案單位', text: '' },
    ...
    methods: {
        ...
        setShowData(obj) {
            ...
            this.topItems.fixUnit.text = obj.CreatorDepart  // 立案單位
            ...
            this.topItems.workDate.text = obj.DispatchDDay  // 維修時間
