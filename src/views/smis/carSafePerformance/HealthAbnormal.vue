    ...
    <v-row class="px-2">
        ...
        <v-col cols="12">
            ...
            <v-btn color="indigo" dark large class="ma-2"
                to="/smis/car-safe-performance/health-abnormal/add"
            >
                ...
                >
                    ...
                    <template v-slot:item.action="{ item }">
                        <v-btn fab small color="primary"
                            target="_blank"
                            class="mr-3"
                            :to="`/smis/car-safe-performance/health-abnormal/${item.FlowID}/edit`"
                        >
...
import { drunkQueryList,drunkUpdate } from '@/apis/smis/safetyPerformance'
...
export default {
    data: () => ({
        ...
        headers: [  // 表格欄位
            ...
            { text: '異常單位', value: 'ErrDepart', align: 'center', divider: true, class: 'subtitle-1 white--text font-weight-bold light-blue darken-1' },
            { text: '異常人員', value: 'ErrPeopleName', align: 'center', divider: true, class: 'subtitle-1 white--text font-weight-bold light-blue darken-1' },
            { text: '異常說明', value: 'ErrDesp', align: 'center', divider: true, class: 'subtitle-1 white--text font-weight-bold light-blue darken-1' },
            { text: '處理情形', value: 'ErrCheckStatus', align: 'center', divider: true, class: 'subtitle-1 white--text font-weight-bold light-blue darken-1' },
