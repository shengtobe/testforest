...
<v-container style="max-width: 1200px">
    <h2 class="mb-4 label-title">酒測、健康檢查異常表查詢</h2>
...
export default {
    data: () => ({
        ...
        headers: [  // 表格欄位
            ...
            { text: '異常單位', value: 'ErrDepart', align: 'center', divider: true, class: 'subtitle-1 white--text font-weight-bold' },
            { text: '異常人員', value: 'ErrPeopleName', align: 'center', divider: true, class: 'subtitle-1 white--text font-weight-bold' },
            { text: '異常說明', value: 'ErrDesp', align: 'center', divider: true, class: 'subtitle-1 white--text font-weight-bold' },
            { text: '處理情形', value: 'ErrCheckStatus', align: 'center', divider: true, class: 'subtitle-1 white--text font-weight-bold' },
