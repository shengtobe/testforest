  ...
  data: () => ({
    ...
    settings: {
      subtitle: [
        ...
        "4.本表於每年6、12月月底前完成檢查，經主管核章後，留存於管理單位，保存三年備查。",
      ],
      qestions: [
        { question: "1. 梯柱有無裂痕、嚴重外傷", method: "目視點檢" },
        { question: "2. 腳踏橫槓有無缺少或斷裂", method: "目視點檢" },
        { question: "3. 腳踏橫槓是否牢固", method: "目視點檢" },
        { question: "4. 固定螺栓有無鬆動脫落", method: "動作測試" },
        { question: "5. 尼龍接繩有無斷股、鬆脫", method: "目視點檢" },
        { question: "6. 梯身有無沾有油脂等易滑物", method: "目視點檢" },
        { question: "7. 伸長時固定鉤動作是否確實", method: "動作測試" },
      ],
      columns: {
        option: "CheckOption",
        memo: "Memo_",
