    ...
    <v-dialog v-model="Add" persistent max-width="1060px" persistent>
      <v-card class="theme-card">
                      ...
                      <v-row no-gutter class="label-header">
                        ...
                        <v-col cols="12" sm="4">
                          <v-radio-group
                            dense
                            row
                            v-model="ipt.items_4[idx].status1"
                            class="pa-0 ma-0">
                            <v-radio color="success" label="正常" value="1"></v-radio>
                            <v-radio color="red" label="異常" value="2"></v-radio>
                          </v-radio-group>
        ...
        <v-card-actions class="px-5 pb-5">
          ...
          <v-btn class="btn-add white--text" @click="save">送出</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </v-container>
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      //   var data = {}
      //   data.CheckDay = this.nowTime
      //   data.SwitchLoc = '1'
      //   data.SwitchNo = '2'
      //   data.SwitchLock = this.ipt.items[index].status1
        ...
        KeyItem:[
          {
            "Chk1": 
                [
                  {
                    "CheckDay":this.zs, "SwitchLoc":"1", "SwitchNo":"2", "SwitchLock":this.ipt.items[0].status1, "Rust":this.ipt.items[0].status2, 
                    "Bearing":this.ipt.items[0].status3, "SwitchClean":this.ipt.items[0].status4, "Memo_1":this.ipt.items[0].note
                  },
                  {
                    "CheckDay":this.nowTime, "SwitchLoc":"1", "SwitchNo":"4", "SwitchLock":this.ipt.items[1].status1, "Rust":this.ipt.items[1].status2, 
                    "Bearing":this.ipt.items[1].status3, "SwitchClean":this.ipt.items[1].status4, "Memo_1":this.ipt.items[1].note
                  },
                  {
                    "CheckDay":this.nowTime, "SwitchLoc":"1", "SwitchNo":"6", "SwitchLock":this.ipt.items[2].status1, "Rust":this.ipt.items[2].status2, 
                    "Bearing":this.ipt.items[2].status3, "SwitchClean":this.ipt.items[2].status4, "Memo_1":this.ipt.items[2].note
                  },
                  {
                    "CheckDay":this.nowTime, "SwitchLoc":"1", "SwitchNo":"8", "SwitchLock":this.ipt.items[3].status1, "Rust":this.ipt.items[3].status2, 
                    "Bearing":this.ipt.items[3].status3, "SwitchClean":this.ipt.items[3].status4, "Memo_1":this.ipt.items[3].note
                  },
                  {
                    "CheckDay":this.nowTime, "SwitchLoc":"1", "SwitchNo":"1", "SwitchLock":this.ipt.items[4].status1, "Rust":this.ipt.items[4].status2, 
                    "Bearing":this.ipt.items[4].status3, "SwitchClean":this.ipt.items[4].status4, "Memo_1":this.ipt.items[4].note
                  },
                  {
                    "CheckDay":this.nowTime, "SwitchLoc":"1", "SwitchNo":"3", "SwitchLock":this.ipt.items[5].status1, "Rust":this.ipt.items[5].status2, 
                    "Bearing":this.ipt.items[5].status3, "SwitchClean":this.ipt.items[5].status4, "Memo_1":this.ipt.items[5].note
                  },
                  {
                    "CheckDay":this.nowTime, "SwitchLoc":"1", "SwitchNo":"5", "SwitchLock":this.ipt.items[6].status1, "Rust":this.ipt.items[6].status2, 
                    "Bearing":this.ipt.items[6].status3, "SwitchClean":this.ipt.items[6].status4, "Memo_1":this.ipt.items[6].note
                  },
                  {
                    "CheckDay":this.nowTime, "SwitchLoc":"1", "SwitchNo":"7", "SwitchLock":this.ipt.items[7].status1, "Rust":this.ipt.items[7].status2, 
                    "Bearing":this.ipt.items[7].status3, "SwitchClean":this.ipt.items[7].status4, "Memo_1":this.ipt.items[7].note
                  },
                  {
                    "CheckDay":this.nowTime, "SwitchLoc":"1", "SwitchNo":"9", "SwitchLock":this.ipt.items[8].status1, "Rust":this.ipt.items[8].status2, 
                    "Bearing":this.ipt.items[8].status3, "SwitchClean":this.ipt.items[8].status4, "Memo_1":this.ipt.items[8].note
                  },
                  {
                    "CheckDay":this.nowTime, "SwitchLoc":"1", "SwitchNo":"11", "SwitchLock":this.ipt.items[9].status1, "Rust":this.ipt.items[9].status2, 
                    "Bearing":this.ipt.items[9].status3, "SwitchClean":this.ipt.items[9].status4, "Memo_1":this.ipt.items[9].note
                  },
                  {
                    "CheckDay":this.nowTime, "SwitchLoc":"1", "SwitchNo":"13", "SwitchLock":this.ipt.items[10].status1, "Rust":this.ipt.items[10].status2, 
                  ...
                  {
                    "CheckDay":this.nowTime, "SwitchLoc":"1", "SwitchNo":"9", "SwitchLock":this.ipt.items_2[2].status1, "Rust":this.ipt.items_2[2].status2, 
