<template>
  <v-container style="max-width: 1200px">
    <h2 class="mb-4 px-2">各級主管走動管理督檢紀錄暨追蹤表(每月2 次)</h2>
    <!-- 第一排選項 -->
    <v-row class="px-2">
      ...
      <v-col cols="12" sm="3" md="3" class="d-flex align-end">
        ...
        <v-btn
          ...
          @click="Add = true"
        >
          <v-icon>mdi-plus</v-icon>新增紀錄追蹤表
        </v-btn>
      </v-col>
    </v-row>
    <!-- 表格資料 -->
    ...
    <v-dialog v-model="Add" max-width="1000px">
      <v-card>
        ...
        <div class="px-6 py-4">
          <v-row>
            <v-col cols="12">
              <p>1.督檢紀錄表(請具體填寫)陳報單位主管核閱後交勞安部門彙整及列入追蹤改善，單位主管需確實督導執行P.D.C.A之追蹤改善制度(繼續追蹤或解除追蹤)。</p>
