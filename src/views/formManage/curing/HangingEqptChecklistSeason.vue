<template>
  <v-container style="max-width: 1200px">
    <h2 class="mb-4 px-2">吊掛用具定期檢查表(三個月)</h2>
    <!-- 第一排選項 -->
    <v-row class="px-2">
  ...
  data() {
    return {
      ...
      items: [
        ...
        { question: "2.吊索直徑減少達公稱直徑百分之七以上者", checkMethod: "實地量測" },
        { question: "3.吊索已扭結者", checkMethod: "目視點檢" },
        { question: "4.吊索有顯著變形或腐蝕者", checkMethod: "目視點檢" },
        { question: "5.吊索末端結頭部份異常者", checkMethod: "目視點檢" },
        { question: "6.吊索鋼索套有裂紋產生", checkMethod: "目視點檢" },
        { question: "7.吊索鋼索套有變形情形，並壓迫傷及鋼索", checkMethod: "目視點檢" },
        { question: "8.吊鏈延伸長度超過百分之五以上", checkMethod: "實地量測" },
        { question: "9.吊鏈環的斷面直徑減少百分之十以上", checkMethod: "實地量測" },
        { question: "10.吊鏈有無龜裂", checkMethod: "目視點檢" },
        { question: "11.吊鏈有無顯著變形", checkMethod: "目視點檢" },
      ],
      suggest: "", // 改善建議
    };
  },
