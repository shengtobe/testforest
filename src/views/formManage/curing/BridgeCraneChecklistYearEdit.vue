          ...
          panelQuestion: [      //題目
            {
              panelLabel: "電氣部份",
              questions: [
                ["吊重電動機","溫度","用手擦拭是否燙手","正常溫度（不燙手；周圍溫度＋20<sup>o</sup>C）",],
                ["吊重電動機","聲音","不正常作鳴鳴之聲","正常聲音",],
                ["吊重電動機","接觸不良","端點螺絲是否鬆弛","充分旋緊",],
                ["走行電動機","溫度","用手擦拭是否燙手","正常溫度（不燙手；周圍溫度＋20<sup>o</sup>C）",],
                ["走行電動機","聲音","不正常作鳴鳴之聲","正常聲音",],
                ["走行電動機","損傷","端點螺絲是否鬆弛","充分旋緊",],
                ["旋轉或橫行電動機","溫度","用手擦拭是否燙手","正常溫度（不燙手；周圍溫度＋20<sup>o</sup>C）",],
                ["旋轉或橫行電動機","聲音","不正常作鳴鳴之聲","正常聲音",],
                ["旋轉或橫行電動機","損傷","端點螺絲是否鬆弛","充分旋緊",],
                ["吊桿升降機或其他用途電動機","溫度","用手擦拭是否燙手","正常溫度（不燙手；周圍溫度＋20<sup>o</sup>C）",],
