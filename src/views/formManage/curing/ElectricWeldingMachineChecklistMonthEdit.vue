...
export default {
  ...
  data: () => ({
    ...
    settings: {
      ...
      qestions: [
        { question: "1. 焊接柄絕緣護層是否有破損或絕緣不良", method: "目視點檢" },
        { question: "2. 電極端子及導線有無破損或絕緣不良", method: "目視點檢" },
        { question: "3. 電源線及電焊機之接點螺絲是否正常", method: "目視點檢" },
        { question: "4. 電源有否裝漏電斷路器，動作是否正常", method: "動作測試" },
        { question: "5. 電源開關及電流調整輪柄是否操作正常", method: "動作測試" },
        { question: "6. 自動電擊防止裝置，動作是否正常", method: "動作測試" },
        { question: "7. 電焊機絕緣電阻是否達標準值", method: "動作測試" },
        { question: "8. 電焊機有無異常的聲音或振動", method: "動作測試" },
        { question: "9. 面罩、手套、腳包、防護衣等護具是否正常", method: "目視點檢" },
      ],
      columns: {
        option: "CheckOption",
        memo: "Memo",
