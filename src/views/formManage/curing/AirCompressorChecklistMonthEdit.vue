...
export default {
  ...
  data: () => ({
    ...
    settings: {
      ...
      qestions: [
        { question: "1. 控制開關及電源線", method: "動作測試" },
        { question: "2. 馬達絕緣及接地線", method: "動作測試" },
        { question: "3. 傳動皮帶、皮帶輪", method: "動作測試" },
        { question: "4. 馬達傳動部份護罩", method: "目視點檢" },
        { question: "5. 貯氣筒體有無裂痕、腐蝕、漏氣", method: "目視點檢" },
        { question: "6. 連接管接頭是否良好", method: "動作測試" },
        { question: "7. 安全閥及送氣開關", method: "動作測試" },
        { question: "8. 壓力表及壓力設定", method: "動作測試" },
        { question: "9. 試運轉是否順暢，有無異狀", method: "動作測試" },
      ],
      columns: {
        option: "CheckOption",
        memo: "Memo_",
