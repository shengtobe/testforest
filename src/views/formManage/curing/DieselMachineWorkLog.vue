<template>
  <v-container style="max-width: 1200px">
    <h2 class="mb-4 px-2">柴油機車使用前後工作日誌</h2>
    <!-- 第一排選項 -->
    <v-row class="px-2">
      <v-col cols="12" sm="4" md="3">
        <h3 class="mb-1">
          <v-icon class="mr-1 mb-1">mdi-calendar-text</v-icon>日誌日期(起)
        </h3>
        <v-menu
          v-model="a"
      ...
      <v-col cols="12" sm="4" md="3">
        <h3 class="mb-1">
          <v-icon class="mr-1 mb-1">mdi-calendar-text</v-icon>日誌日期(迄)
        </h3>
        <v-menu
          v-model="q"
          :close-on-content-click="false"
      ...
      <v-card>
        ...
        <div class="px-6 py-4">
          <v-row>
            ...
            <!-- 填寫人 -->
            <v-col cols="8" sm="4">
              <h3 class="mb-1">車庫長</h3>
              <v-text-field v-model="yy" solo />
            </v-col>
            <!-- 狀況及原因 -->
            <v-col cols="12">
              <v-textarea hide-details label="工作項目 - 上午" auto-grow outlined rows="8" v-model.trim="ii" />
            </v-col>
            <v-col cols="12">
              <v-textarea hide-details label="工作項目 - 下午" auto-grow outlined rows="8" v-model.trim="ii2" />
            </v-col>
            <v-col cols="12">
              <v-textarea hide-details label="無法修護項目" auto-grow outlined rows="8" v-model.trim="ii3" />
            </v-col>
            <v-col cols="12">
              <v-textarea hide-details label="處理情形" auto-grow outlined rows="8" v-model.trim="ii4" />
            </v-col>
          </v-row>
        </div>
