<template>
  <v-container style="max-width: 1200px">
    <h2 class="mb-4 px-2">固定式起重機每日作業前檢點表(作業前)</h2>
    <!-- 第一排選項 -->
    <v-row class="px-2">
    ...
    <v-dialog v-model="Add" max-width="900px">
      <v-card>
        ...
        <div class="px-6 py-4">
          <v-row>
            <v-col cols="12">
              <p>1.依職業安全衛生法第23條及職業安全衛生管理辦法第52條規定辦理。</p>
            ...
            <v-col cols="12">
              ...
              <v-expansion-panels v-model="panel" :disabled="disabled" multiple>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <v-alert
                      ...
                      <v-row no-gutter>
                        ...
                        <v-col cols="12" sm="3">{{ item.checkContent }}</v-col>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header color="teal" class="white--text">剎車控制器</v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <v-row no-gutter class="indigo--text darken-2 d-none d-sm-flex font-weight-black"
                    >
                      <v-col cols="12" sm="3">
    ...
    return {
      ...
      items1: [
        //過捲預防裝置
        {
          question: "1. 吊物升降極限開關",
          checkContent: "動作",
          checkMethod: "動作是否確實螺絲有否鬆弛",
        },
      ],
      items2: [
        //剎車控制器
        { question: "1.電磁升降剎車", checkContent: "動作",checkMethod: "反覆操作上升查看其動作狀況停止位置" },
        { question: "2.電磁走行剎車", checkContent: "動作",checkMethod: "反覆操作上升查看其動作狀況停止位置" },
        { question: "3.渦電流或其他控制下降剎車", checkContent: "動作",checkMethod: "查看降落速度是否適當" },
        { question: "4.直接控器", checkContent: "動作",checkMethod: "反覆操作查看其動作狀況" },
        { question: "5.間接控制器", checkContent: "動作",checkMethod: "反覆操作查看其動作狀況及電譯情形" },
        { question: "6.軌道", checkContent: "損傷斷裂",checkMethod: "檢視" },
        { question: "7.吊運車橫行導軌", checkContent: "損傷斷裂",checkMethod: "檢視" },
        { question: "8.軌道上障礙物", checkContent: "目視",checkMethod: "是否移開" },
      ],
      items3: [
        //鋼纜
        {
      ...
      items4: [
        //警報裝置
        { question: "1.行走警鈴", checkContent: "響亮",checkMethod: "行走時響亮" },
        { question: "2.警報器", checkContent: "響亮",checkMethod: "按動時鳴叫" },
      ],
      items5: [
        //吊鉤
        { question: "1.吊鉤", checkContent: "損傷",checkMethod: "檢視有無損傷斷裂" },
        { question: "2.吊鉤安全栓", checkContent: "損傷",checkMethod: "檢視有無損傷斷裂" },
      ],
      suggest: "", // 改善建議
    };
  },
