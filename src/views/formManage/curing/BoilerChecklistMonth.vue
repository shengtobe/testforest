...
import EditPage from '@/views/formManage/curing/BoilerChecklistMonthEdit'
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "保養日期", value: "CheckDay", align: "center", divider: true, class: "subtitle-1 white--text font-weight-boldlabel-header" },
        ...
        { text: "保養單位", value: "DepartName", align: "center", divider: true, class: "subtitle-1 white--text font-weight-boldlabel-header" },
