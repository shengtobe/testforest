  ...
  data: () => ({
    ...
    settings: {
      subtitle: [
        ...
        "2.檢查結果應詳實紀錄。檢查結果請依情況選擇正常、異常、無此項目。",
        "3.缺點由使用單位自行改善，不克者委請設備商修護。",
        "4.本定期檢查表於每年1.4.7.10月月底前完成檢查，經主管核章後，留存於管理單位之系統保存備查。",
      ],
      qestions: [
        { question: "1. 引擎齒輪油是否正常", method:"抽取探測棒" },
        { question: "2. 煞車系統是否正常", method:"踏踩測試" },
        { question: "3. 空氣濾清器是否正常", method:"必要時更換" },
        { question: "4. 電瓶樁頭、電瓶水是否正常", method:"扳動、目視電瓶液位" },
        { question: "5. 鋼輪外表及行走狀況是否正常", method:"目視及動作測試" },
        { question: "6. 方向桿裝置是否正常", method:"動作測試" },
        { question: "7. 油量是否正常", method:"目視" },
        { question: "8. 燈光、喇叭是否正常", method:"測試" },
        { question: "9. 其其他(車身結構外表)是否正常", method:"目視" },
      ],
      columns: {
        option: "CheckOption",
      },
