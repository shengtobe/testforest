<template>
  <v-container style="max-width: 1200px">
    <h2 class="mb-4 px-2">鋼軌鋸軌、鑽孔、磨軌機定期檢查表(三個月)</h2>
    <!-- 第一排選項 -->
    <v-row class="px-2">
        ...
        <div class="px-6 py-4">
          <v-row>
            <v-col cols="12">
              ...
              <p>3.本定期檢查表於每年1.4.7.10月月底前完成檢查，經主管核章後，留存於管理單位之系統保存備查。</p>
            </v-col>
            <!-- 檢查項目 -->
            <v-col cols="12">
...
export default {
  data() {
    return {
      ...
      items: [
        { question: "1.機油液面是否正常、油質良好", checkMethod: "檢視標尺" },
        { question: "2.各油管表面是否漏油", checkMethod: "目視點檢" },
        { question: "3.各安裝螺絲是否有鬆弛", checkMethod: "目視點檢" },
        { question: "4.輪鋸片、研磨輪、鑽頭是否有裂痕", checkMethod: "動作測試" },
        { question: "5.機械防護裝置安裝良好(例:護罩)", checkMethod: "目視點檢" },
        { question: "6.每日作業開始前試轉一分鐘以上", checkMethod: "作用檢查" },
        { question: "7.各活動部位是否清潔、上油潤滑", checkMethod: "目視點檢" },
        { question: "8.引擎啟動時、啟動後、加速時是否有異音", checkMethod: "動作測試" },
        { question: "9.操作人員個人防護具(例:護目鏡、安全帽)", checkMethod: "目視點檢" },
