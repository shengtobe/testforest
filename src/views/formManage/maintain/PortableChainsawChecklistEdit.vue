  ...
  data: () => ({
    ...
    settings: {
      subtitle: [
        ...
        "4.本定期檢查表於每年 1.4.7.10月月底前完成檢查。",
      ],
      qestions: [
        { question: "1. 鏈條是否牢固、有無外傷不堪使用", method: "動作測試", },
        { question: "2. 引擎是否固定良好、有無漏油現象", method: "目視點檢", },
        { question: "3. 護罩及提把是否良好", method: "目視點檢", },
        { question: "4. 安全開關及油門是否順暢", method: "動作測試" },
        { question: "5. 各部位螺栓有無鬆脫", method: "動作測試" },
        { question: "6. 試運轉是否順暢正常", method: "動作測試" },
      ],
      columns: {
        option: "CheckOption",
        memo: "Memo_",
