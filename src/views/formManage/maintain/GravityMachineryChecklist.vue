<template>
  <v-container style="max-width: 1200px">
    <h2 class="mb-4 px-2">重力機械使用前檢查表</h2>
    <!-- 第一排選項 -->
    <v-row class="px-2">
    ...
    <v-dialog v-model="Add" max-width="900px">
      <v-card>
        ...
        <div class="px-6 py-4">
          <v-row>
            <v-col cols="12">
              <p>1.依檢查結果選擇良好、尚可、不良待修。</p>
              <p>2.本表經主管核章後，留存於管理單位，保存三年備查。</p>
            </v-col>
            <!-- 檢查項目 -->
            <v-col cols="12">
                ...
                <v-row no-gutter>
                  ...
                  <v-col cols="12" sm="5">
                    ...
                    <v-radio-group dense row v-model="ipt.items[idx].status" class="pa-0 ma-0">
                      ...
                      <v-radio color="black" label="尚可" value="2"></v-radio>
                      <v-radio color="red" label="不良待修" value="0"></v-radio>
                    </v-radio-group>
                  </v-col>
                  <v-col cols="12" sm="4">
