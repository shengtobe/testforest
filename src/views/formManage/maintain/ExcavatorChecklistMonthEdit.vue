  ...
  data: () => ({
    ...
    settings: {
      subtitle: [
        ...
        "4.本表於月底前完成檢查，經主管核章後，留存於管理單位，保存三年備查",
      ],
      qestions: [
        { question: "1. 制動器及操作裝置是否正常", method: "動作測試" },
        { question: "2. 離合器操作裝置是否正常", method: "動作測試" },
        { question: "3. 鋼索、鏈有無損傷斷裂", method: "目視點檢" },
        { question: "4. 吊斗有無損傷斷裂", method: "目視點檢" },
        { question: "5. 引擎水箱冷卻水水量是否正常", method: "目視點檢" },
        { question: "6. 引擎機油及柴油油量是否正常", method: "目視點檢" },
        { question: "7. 履帶鬆緊度及表面是否正常", method: "動作測試及目視點檢" },
        { question: "8. 電瓶及電器設備是否正常", method: "動作測試" },
        { question: "9. 機械各動作部分潤滑是否正常", method: "目視點檢" },
        { question: "10. 空氣濾清器清潔度是否正常", method: "目視點檢" },
        { question: "11. 操作液壓油油量是否正常", method: "目視點檢" },
        { question: "12. 方向操作系統動作是否正常", method: "動作測試" },
        { question: "13. 剎車能力動作情況檢查是否正常", method: "動作測試" },
        { question: "14. 儀表、燈及喇叭操作情況檢查是否正常", method: "動作測試" },
        { question: "15. 各部機件是否有漏油現象", method: "目視點檢" },
        { question: "16. 各部機件是否有異常聲音及不正常動作", method: "動作測試" },
      ],
      columns: {
        option: "CheckOption",
        memo: "Memo_",
