<template>
  <v-container style="max-width: 1200px">
    <h2 class="mb-4 px-2">機動道班台車使用申請書</h2>
    <!-- 第一排選項 -->
    <v-row class="px-2">
      <v-col cols="12" sm="3">
        <h3 class="mb-1">
        ...
        >
          ...
          <v-date-picker color="purple" v-model="z" @input="a = false" locale="zh-tw" />
        </v-menu>
      </v-col>
      <v-col cols="12" sm="3">
        <h3 class="mb-1">
        ...
        >
          ...
          <v-date-picker color="purple" v-model="df" @input="q = false" locale="zh-tw" />
        </v-menu>
      </v-col>
      <v-col cols="12" sm="3">
        <h3 class="mb-1">
